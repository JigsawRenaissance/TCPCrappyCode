...
void adbEventHandler(Connection * connection, adb_eventType event, uint16_t length, uint8_t * data)
{
  ...
  // If the Board receives the data from the serial line....
  if (event == ADB_CONNECTION_RECEIVE) {
    Serial.println("ADB_CONNECTION_RECEIVE");
    for (i=0; i<length; i++) {
      // it writes it back to serial line...
      Serial.write(data[i]);
    }
...
void loop()
{
   ...
   if (ConsoleComplete) {
    ...
    //////////////////////////////////////////////////////////////////////////////////
    // START: This writes data to the Phone console (Arduino ---> Android)
    //////////////////////////////////////////////////////////////////////////////////
    connection->write(ConsoleIndex, (uint8_t*)ConsoleString);
    //connection->read
    //////////////////////////////////////////////////////////////////////////////////
    // END: This writes data to the Phone console
    //////////////////////////////////////////////////////////////////////////////////
    //////////////////////////////////////////////////////////////////////////////////
